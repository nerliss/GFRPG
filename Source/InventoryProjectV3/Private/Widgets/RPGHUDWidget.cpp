...
void URPGHUDWidget::DisplayInteractionMessage(bool bShowMessage, FText TargetName)
{
	...
	if (!InteractionPrompt_Widget)
	{
		InteractionPrompt_Widget = Cast<URPGInteractionPromptWidget>(CreateWidget(GetWorld(), InteractionPrompt_WidgetClass));
